...
('2518407786529', N'Nhà Giả Kim', N'Paulo Coelho', 2013,N'Nhà Xuất Bản Văn Học', N'Tất cả những trải nghiệm trong chuyến phiêu du theo đuổi vận mệnh của mình đã giúp Santiago thấu hiểu được ý nghĩa sâu xa nhất của hạnh phúc, hòa hợp với vũ trụ và con người.',228, 5,6,'\uploads\images\2518407786529.jpg', 1),
('9786045985007', N'Để Làm Nên Sự Nghiệp', N'H.N Casson', 2017,N'Nhà Xuất Bản Lao Động', N'Đây là một cuốn sách có nội dung thiết thực, hữu ích. Nó cung cấp cho bạn đọc những tri thức, kỹ năng sống, bài học bổ ích trong lĩnh vực kinh doanh nói riêng và cuộc sống nói chung. Cuốn sách là một cẩm nang không thể bỏ qua đối với những ai đang có ý định lập nghiệp bằng con đường kinh doanh, cũng như những ai đã và đang thành công trên thương trường.',219, 6, 4,'\uploads\images\9786045985007.jpg',1),
...
('2448120945562', N'Code Dạo Kí Sự - Lập Trình Viên Đâu Phải Chỉ Biết Code',N'Phạm Huy Hoàng (Developer)',2017,N'Nhà Xuất Bản Dân Trí', N' Code Dạo Kí Sự - Lập Trình Viên Đâu Phải Chỉ Biết Code',266, 11, 3,'\uploads\images\2448120945562.jpg', 1)
END
GO
...
VALUES (N'Hồ Minh Tuấn', N'Nam', '1997-1-26', '261541432', N'Quận Tân Bình','0833475600', '2019-10-16', 'hominhtuan2611@gmail.com', '8BFDDF77E9A5F1BBA409873BA255538D2357CC88', 1),
(N'Nguyễn Như Sang', N'Nam', '1997-10-02', '647381962', N'Quận 3','0987165433', '2019-10-10', 'sangnguyen@gmail.com', '8BFDDF77E9A5F1BBA409873BA255538D2357CC88', 1),
(N'Hồ Thị Mận', N'Nữ', '1997-8-20', '878436251', N'Quận 5','0986386291', '2019-12-10', 'manho@gmail.com', '8BFDDF77E9A5F1BBA409873BA255538D2357CC88', 1),
(N'Nguyễn Văn A', N'Nam', '1997-5-12', '238657644', N'Quận 4','0186564864', '2019-12-10', 'nguyennhus293@gmail.com', '8BFDDF77E9A5F1BBA409873BA255538D2357CC88', 1)
END
GO
...
VALUES (1, 1, '2019-10-26', 2, '2019-11-5', 1, 3),
(2, 2, '2019-11-10', 3, '2019-11-19', 1, 3),
(4, 2, '2019-11-10', 2, '2019-11-20', 0, 4),
(3, 2, '2019-11-10', 1, '2019-11-20', 1, 3),
(2, 2, '2019-11-10', 1, '2019-11-21', 1, 3),
(1, 2, '2019-11-10', 2, '2019-11-22', 1, 3),
(1, 2, '2019-11-23', 3, '2019-11-30', 0, 2),
(1, 2, '2019-11-24', 3, '2019-11-30', 1, 4),
(1, 3, CAST(GETDATE() AS DATE), 2, DATEADD(DAY, 10, CAST(GETDATE() AS DATE)), 0, 2)
END
GO
...
BEGIN
INSERT INTO [CTPhieuMuon] ([PhieuMuon],[Book],[SoLuong],[TinhTrangSach]) 
VALUES (1, '9552147738847',1, N'Tốt'),
(1, '9780512479372',1, N'Tốt'),
(2, '8935236402088',1, N'Tốt'),
(2, '2393362046440',1, N'Tốt'),
(2, '9786049608261',1, N'Tốt'),
(3, '2518407786529',1, ''),
(3, '2393362046440',1, ''),
(4, '9786049608261',1, N'Tốt'),
(5, '9786049608261',1, N'Tốt'),
(6, '5013546003942',1, N'Tốt'),
(6, '2448120945562',1, N'Tốt'),
(7, '8935236402088',1, ''),
(7, '2448120945562',1, ''),
(7, '9552147738847',1, ''),
(8, '9552147738847',1, ''),
