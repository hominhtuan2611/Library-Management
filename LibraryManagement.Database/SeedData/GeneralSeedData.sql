...
('5816014371082', N'Công Phá Bài Tập Hóa lớp 10-11-12', N'Trần Phương Duy', 2018,N'Nhà Xuất Bản Đại Học Quốc Gia Hà Nội', N'Thử thách bản thân với hàng loạt bài tập phân bổ đều cả 3 lớp 10-11-12, được chọn lọc kĩ càng. Cả cuốn sách được chia thành 20 chương theo từng dạng bài cụ thể và 10 chương theo từng phương pháp giải bài tập điển hình. Các bài tập trong cuốn sách đều là những bài tập điển hình và quen thuộc nhất trong các đề thi thử THPT quốc gia và chính các bài kiểm tra trên lớp của các em học sinh. Ngoài các ví dụ giúp các bạn định hình dạng toán, cuốn sách còn bao hàm rất nhiều bài tập tự luyện có đáp án, giúp các bạn giải quen dạng và quen tay, nhằm tối ưu hóa thời gian khi làm các đề thi.',622, 8, 1),
('6792841728659', N'Công Phá Bài Tập Sinh', N'Trần Phương Duy', 2018,N'Nhà Xuất Bản Đại Học Quốc Gia Hà Nội', N'Với những sự khác biệt từ nội dung tới hình thức, tới cách thức hỗ trợ sau khi mua sách, chúng tôi tin tưởng chắc chắn rằng CÔNG PHÁ BÀI TẬP SINH 10-11-12 và CÔNG PHÁ LÍ THUYẾT SINH 10-11-12 sẽ giúp các em tự tin với môn Sinh hơn trong mọi kì thi. Hãy đọc và cảm nhận tâm huyết trên từng trang sách của chúng tôi ngay từ bây giờ quý độc giả nhé!',478, 8, 1),
('2393362046440', N'Đột Phá Mindmap - Tư Duy Đọc Hiểu Môn Ngữ Văn Bằng Hình Ảnh Lớp 12', N'Trịnh Văn Quỳnh', 2016,N'Nhà Xuất Bản Đại Học Quốc Gia Hà Nội', N'Đột Phá Mindmap - Tư Duy Đọc Hiểu Môn Ngữ Văn Bằng Hình Ảnh Lớp 12 sẽ mang đến một phương pháp học văn hoàn toàn mới mẻ - Học văn bằng tư duy Mindmap.',307, 8, 1),
('9786046324416', N'Những Điều Trường Lpws Không Thể Dạy', N'Nguyễn Văn Yên, S.J', 2017,N'Nhà Xuất Bản Phương Đông', N'"Đừng ngần ngại nữa, hãy xách balo lên và đi!" Đó là lời động viên, mang tính cách tuyên ngôn, đã lưu lại nhiều ảnh hưởng mạnh mẽ trên các bạn trẻ trong thời gian qua. Nhiều người thích thú chia sẻ với nhau câu hỏi: "thế giới này là một quyển sách. Ai chưa từng xách balo lên và đi thì mới chỉ đọc duy nhất một trang của cuốn sách ấy"',155, 9, 1),
('9786046131045', N'Đường Về Thượng Trí', N'Nguyễn Tầm Thường', 2011,N'Nhà Xuất Bản Tôn Giáo', N'Những chuyện ngắn của cha Nguyễn Tầm Thườngvừa lôi cuốn vừa nhẹ nhàngdẫn người đọc vàođời sống tâm linh.',242, 9, 1),
('8215687358258', N'Từ Điển Hán - Việt', N'	Phan Văn Các',null,N'Nhà Xuất Bản Dân Trí', N'"Từ điển Hán - Việt" là tài liệu tham khảo cần thiết đối với những người học và sử dụng tiếng Trung Quốc. Cuốn từ cung cấp một khối lượng từ phong phú, đa dạng. Trong đó đa phần là các từ hiện đại, được sử dụng phổ biến trong cuộc sống hàng ngày và trên các phương tiện thông tin đại chúng.',2024, 10, 1),
...
('1929085920289', N'Từ Điển Nhật - Việt', N'Nguyễn Văn Khang',2018,N'Nhà Xuất Bản Đại Học Quốc Gia Hà Nội', N'Từ Điển Nhật - Việt là cuốn sách thu thập và giải thích những chữ Hán thông dụng trong tiếng Nhật gồm: 1945 Joyo Kanji, 18.000 tổ hợp, 2.000 thuật ngữ. Đồng thời cuốn sách này sẽ chỉ dẫn cho các bạn cách viết chữ Hán, cũng như chỉ cho các bạn cách đọc ON/KUN phiên âm La Tinh và cách đọc Hán Việt của Tiếng Việt.',894, 10, 1),
('2448120945562', N'Code Dạo Kí Sự - Lập Trình Viên Đâu Phải Chỉ Biết Code','Phạm Huy Hoàng (Developer)',2017,N'Nhà Xuất Bản Dân Trí', N' Code Dạo Kí Sự - Lập Trình Viên Đâu Phải Chỉ Biết Code',266, 11, 1)
END
GO
